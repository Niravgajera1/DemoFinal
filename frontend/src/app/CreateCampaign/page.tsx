  ...
  return (
    <>
      <div className="flex flex-col  justify-center items-center h-screen">
        <div className="flex flex-col gap-6 justify-center items-center max-w-xl w-full p-6 bg-greay rounded-lg shadow-xl backdrop-blur-xm bg-black/30">
          <div className="bg-stone-500 flex flex-col justify-center p-1/2 rounded-lg ">
            <h4 className=" w-25 p-3 font-bold text-black border-bottom border-3 border-success-subtle opacity-75 m-4">
              Create A Campaign!
            </h4>
          </div>
          ...
          <button className="bg-stone-700 text-white p-2 w-full rounded-lg text-center hover:border hover:bg-transparent hover:border-stone-700 hover:text-stone-800 transfrom duration-300">
            Submit
          </button>
        </div>
      </div>
